### Jay Stewart — AI-native software engineer

I build production systems where AI agents write most of the code — more
than 8 in 10 commits across my two production codebases were written or
co-written by an agent (counted from git history on 2026-08-05, not
estimated), inside verification gates built so the output can be trusted.
Backend engineering since 2012, either side of a six-year break; everything
below was built since March 2026.
...
Now measuring what agent-operated delivery actually changes — and talking to
teams doing the same. Also open to backend, platform or founding engineering
roles.
